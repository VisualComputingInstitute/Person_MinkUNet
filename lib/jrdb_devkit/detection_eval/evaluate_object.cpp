...
// /* ---- NOTE Hack for laser evaluation ---- */
// const int32_t MIN_3D_N_POINTS = 5;
// /* ---------------------------------------- */
...
inline double box3DOverlap(tDetection d, tGroundtruth g, int32_t criterion = -1) {
    ...
    // /* ---- NOTE Hack for BEV evaluation ---- */
    // double det_area = d.l * d.w;
    // double gt_area = g.l * g.w;

    // double oo;
    // if(criterion==-1)     // union
    //     oo = inter_area / (det_area + gt_area - inter_area);
    // else if(criterion==0) // bbox_a
    //     oo = inter_area / det_area;
    // else if(criterion==1) // bbox_b
    //     oo = inter_area / gt_area;
